...
<div id="main">
    <div class="card">
        ...
        <div class="content">
            <div class="info">
                <div class="info-item user-picture">
                    <img alt="Your Slack Username" data-testid="slackDisplayImage" src="assets/profile_pic.png">
                    <div class="user-details">
                        <h1><span data-testid="slackUserName">Didier Senou</span> 🚀 </h1>
                        <p data-testid="myTrack">Frontend Developer</p>
                        <div>
                            <a target="_blank" data-testid="githubURL" href="">
                ...
                <div class="date-container">
                    <div class="info-item absolute first">
                        <p class="title">Today:</p>
                        <p data-testid="currentDayOfTheWeek"></p>
                    </div>

                    <div class="info-item absolute last">
...
test('Check presence of elements with data-testid attributes', () => {
    ...
    const githubURL = document.querySelector('a[data-testid="githubURL"]');

    // Assert that the elements exist
    expect(slackUserNameElement).toBeTruthy();
    expect(currentDayOfTheWeekElement).toBeTruthy();
    expect(currentUTCTimeElement).toBeTruthy();
    expect(slackDisplayImage).toBeTruthy();
    expect(myTrack).toBeTruthy();
